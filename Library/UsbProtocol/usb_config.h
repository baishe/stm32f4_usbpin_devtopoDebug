...
#define CONFIG_USBHOST_MAX_RHPORTS          1       // host 数量
#define CONFIG_USBHOST_MAX_EXTHUBS          3       // hub的数量,无论串并
#define CONFIG_USBHOST_MAX_EHPORTS          7       // hub的下行端口最大数量
#define CONFIG_USBHOST_MAX_INTERFACES       8       // 单个设备里最多包含的接口数量(如果是键鼠那就是2个)
